 ...
 * @author dosen
 */
public final class DlgRestoreRuangan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRestoreRuangan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        Object[] row={"P","Kode Ruangan","Nama Ruangan"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        for(i=0;i<tbJnsPerawatan.getRowCount();i++){ 
            if(tbJnsPerawatan.getValueAt(i,0).toString().equals("true")){
                Sequel.mengedit("ruangan","kd_ruangan='"+tbJnsPerawatan.getValueAt(i,1).toString()+"'","status='1'");
            }
        }        
        BtnCariActionPerformed(evt);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbJnsPerawatan.getRowCount();i++){ 
            if(tbJnsPerawatan.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("ruangan","kd_ruangan",tbJnsPerawatan.getValueAt(i,1).toString());
            }
        }        
        BtnCariActionPerformed(evt);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRestoreRuangan dialog = new DlgRestoreRuangan(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from ruangan where status='0' and kd_ruangan like ? "+
                    "or status='0' and nm_ruangan like ? order by kd_ruangan");
            try {
