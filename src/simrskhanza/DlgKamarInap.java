...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NmDokterCari = new widget.Label();
        NmKamarCari = new widget.Label();
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-03-2023" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-03-2023" }));
        ...
        NmDokterCari.setName("NmDokterCari"); // NOI18N
        NmDokterCari.setPreferredSize(new java.awt.Dimension(1, 1));
        panelGlass9.add(NmDokterCari);

        NmKamarCari.setName("NmKamarCari"); // NOI18N
        NmKamarCari.setPreferredSize(new java.awt.Dimension(1, 1));
        panelGlass9.add(NmKamarCari);
...
//        }else if((TOut.getText().length()==0)&&(norawat.getText().length()>0)){
        if(tabMode.getRowCount()==0){
            ...
            if(tbKamIn.getSelectedRow()>-1){
                if(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),20).toString().equals("Belum Bayar")){
                     JOptionPane.showMessageDialog(null,"Maaf, Selesaikan Pembayaran Terlebih Dahulu dan Silahkan Hubungi Kasir !!!");
                     tbKamIn.requestFocus();                                         
                }else if(norawat.getText().trim().equals("")){
                    JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu data inap pasien yang mau pulang dengan mengklik data pada table...!!!");
                    tbKamIn.requestFocus();           
                }else{
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
                      ...
                      try {
                          ...
                          try {
                              ...
                              if(rs2.next()){
                                    ...
                                    penjualan.isCek();
                                    penjualan.setDokter(NmDokterCari.getText(),NmKamarCari.getText());
    ...
    */
    ...
    private widget.Label NmDokterCari;
    private widget.Label NmKamarCari;
    ...
    private void getData() {
        ...
        if(tbKamIn.getSelectedRow()!= -1){
            ...
            NmDokterCari.setText(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),18).toString());
            NmKamarCari.setText(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),7).toString());                    
        }
    }
