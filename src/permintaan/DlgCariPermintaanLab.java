        ...
        if(TabRawatJalan.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    int opsi = JOptionPane.showConfirmDialog(null, "Apakah anda yakin menghapus data permintaan lab ini ?", "Konfirmasi", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
                    if (opsi == JOptionPane.YES_OPTION){  
                        if(Hasil.isEmpty()==true && akses.gethapus_data_lab() || Hasil.isEmpty()==true && akses.getkode().equals("Admin Utama")){                      
...
//                            Sequel.meghapus("permintaan_lab","noorder",NoPermintaan);
                            Sequel.queryutf("delete from permintaan_lab where noorder='"+ NoPermintaan +"' and no_rawat='"+ NoRawat +"'");                            
                            TeksKosong();
                            tampil(); 
                        }else{
                            JOptionPane.showMessageDialog(null, "Data tidak dapat dihapus karena sudah ada hasil pemeriksaan !!!");
//                                Sequel.meghapus("permintaan_lab","noorder",NoPermintaan);
                        }                          
                    }else{
//                        JOptionPane.showMessageDialog(null,"Maaf, Sudah ada hasil periksa lab ...!!!!");
                    }
                }
            }else{            
