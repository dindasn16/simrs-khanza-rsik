...
public class DlgKunjunganRalanRM2 extends javax.swing.JDialog {
    ...
    public DlgKunjunganRalanRM2(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"No.","NIK","Lama","Baru","Nama Pasien","L","P","TL","Alamat","TMD","Kode ICD","Poli","Cara Bayar","Status Lanjut","Dokter"}){
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{"No.","NIK","Lama","Baru","Nama Pasien","L","P","TL","Alamat","TMD","Kode ICD","Poli","Cara Bayar","Status Lanjut","Dokter"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void initComponents() {
        ...
        TabRawat.addTab("Ralan", internalFrame2);
        ...
        TabRawat.addTab("Ranap", internalFrame3);
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        if (TCari.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Silahkan Isi Kata Kunci Terlebih dahulu !!!");
        }else{
...
//                "concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar, penjab.png_jawab, reg_periksa.status_lanjut, pasien.no_ktp, pasien.tgl_lahir " +
                "concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar, penjab.png_jawab, reg_periksa.status_lanjut, pasien.no_ktp, pasien.tgl_lahir, diagnosa_pasien.kd_penyakit " +
...
//                "inner join kabupaten inner join kecamatan inner join kelurahan on reg_periksa.kd_dokter=dokter.kd_dokter " +
                "from reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab inner join diagnosa_pasien " +
                "inner join kabupaten inner join kecamatan inner join kelurahan on reg_periksa.kd_dokter=dokter.kd_dokter and diagnosa_pasien.no_rawat=reg_periksa.no_rawat " +
...
//                "(poliklinik.nm_poli like ? or dokter.nm_dokter like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or pasien.alamat like ?) order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
                "(poliklinik.nm_poli like ? or dokter.nm_dokter like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or pasien.alamat like ? or diagnosa_pasien.kd_penyakit like ? or pasien.no_ktp like ?) order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
//            }
...
//                            diagnosa=rs2.getString(2);
                    ...
                    tabMode.addRow(new Object[]{
                        i,rs.getString("no_ktp"),setlama,setbaru,rs.getString("nm_pasien"),umurlk,umurpr,rs.getString("tgl_lahir"),rs.getString("almt_pj"),rs.getString("tgl_registrasi"),rs.getString("diagnosa_pasien.kd_penyakit"),rs.getString("poliklinik.nm_poli"),rs.getString("penjab.png_jawab"),rs.getString("reg_periksa.status_lanjut"),rs.getString("nm_dokter")
                    });                
                    i++;
                }
                if(i>=2){
...
//            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar," +
                        "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                        "concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,penjab.png_jawab,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar, penjab.png_jawab, reg_periksa.status_lanjut, pasien.no_ktp, pasien.tgl_lahir, bangsal.nm_bangsal, diagnosa_pasien.kd_penyakit " +
                        "from reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab inner join kamar_inap inner join kamar inner join bangsal inner join dpjp_ranap inner join diagnosa_pasien " +
                        "inner join kabupaten inner join kecamatan inner join kelurahan on dpjp_ranap.kd_dokter=dokter.kd_dokter and dpjp_ranap.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar = kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and diagnosa_pasien.no_rawat=reg_periksa.no_rawat " +
                        "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj " +
                        "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel " +
...
//                        }
                        ...
                        while(rs.next()){
                            ...
                            try {
                                ...
                                System.out.println("laporan.DlgKunjunganRalanRM2.tampil2() 2 :"+e);
                            } finally{
                                if(rs2!=null){
                                    rs2.close();
                                }
...
//                            diagnosa=rs2.getString(2);
                ...
                System.out.println("laporan.DlgKunjunganRalanRM2.tampil3() : "+e);
            } finally{
                if(rs!=null){
                    rs.close();
                }
...
//            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar," +
                        "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                        "concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,penjab.png_jawab,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar, penjab.png_jawab, reg_periksa.status_lanjut, pasien.no_ktp, pasien.tgl_lahir " +
                        ...
                        "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj " +
                        "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel " +
                        "where reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='ranap' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
...
//                        }
                        ...
                        while(rs.next()){
                            ...
                            try {
                                ...
                                System.out.println("laporan.DlgKunjunganRalanRM2.tampil4() 2 :"+e);
                            } finally{
                                if(rs2!=null){
                                    rs2.close();
                                }
                        ...
                        System.out.println("laporan.DlgKunjunganRalanRM2.tampil4() : "+e);
                    } finally{
                        if(rs!=null){
                            rs.close();
                        }
