...
import simrskhanza.DlgCariRuangan;
...
public class IPSRSPermintaan extends javax.swing.JDialog {
    ...
    private DlgCariRuangan cariruangan=new DlgCariRuangan(null,false);    
    ...
    public IPSRSPermintaan(java.awt.Frame parent, boolean modal) {
        ...
        nmruangan.setDocument(new batasInput((byte)50).getKata(nmruangan));
...
//        }
        cariruangan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(cariruangan.getTable().getSelectedRow()!= -1){   
                    kdruangan.setText(cariruangan.getTable().getValueAt(cariruangan.getTable().getSelectedRow(),0).toString());
                    nmruangan.setText(cariruangan.getTable().getValueAt(cariruangan.getTable().getSelectedRow(),1).toString());
    ...
    private void initComponents() {
        ...
        label13.setBounds(430, 10, 75, 23);
        ...
        panelisi3.add(kdptg);
        kdptg.setBounds(510, 10, 76, 23);

        nmptg.setEditable(false);
        nmptg.setName("nmptg"); // NOI18N
        nmptg.setPreferredSize(new java.awt.Dimension(207, 23));
        panelisi3.add(nmptg);
        nmptg.setBounds(590, 10, 190, 23);
        ...
        btnPetugas.setBounds(780, 10, 28, 23);

        label14.setText("Departemen :");
        label14.setName("label14"); // NOI18N
        label14.setPreferredSize(new java.awt.Dimension(70, 23));
        panelisi3.add(label14);
        label14.setBounds(430, 40, 75, 23);
        ...
        btnSuplier1.setBounds(390, 40, 28, 23);
        ...
        kdruangan.setBounds(95, 40, 90, 23);
        ...
        if(NoPermintaan.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(Sequel.menyimpantf2("permintaan_non_medis","?,?,?,?,?","No.Permintaan",5,new String[]{
                        NoPermintaan.getText(),nmruangan.getText(),kdptg.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),"Baru"
                    })==true){
...
private void TanggalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalKeyPressed
        Valid.pindah(evt,NoPermintaan,nmruangan);
