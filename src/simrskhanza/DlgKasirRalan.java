...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-01-2023" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-01-2023" }));
        ...
        NmPoliCari.setName("NmPoliCari"); // NOI18N
        NmPoliCari.setPreferredSize(new java.awt.Dimension(1, 1));
        panelGlass9.add(NmPoliCari);
...
private void MnPenjualanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenjualanActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                ...
                penjualan.isCek();
                penjualan.setDokter(NmDokterCari.getText(),NmPoliCari.getText());                
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    */
    ...
    private widget.Label NmPoliCari;
    ...
    private void getDatakasir() {
        if(tbKasirRalan.getSelectedRow()!= -1){
            ...
            NmDokterCari.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString());
            NmPoliCari.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),4).toString());              
        }
    }
