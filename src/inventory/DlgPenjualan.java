...
//                        tbObat.setValueAt(0,tbObat.getSelectedRow(),10);
//                    }                
//                }else if(tbObat.getSelectedColumn()==12){
    ...
    private void BtnNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnNotaActionPerformed
        ...
        if(NoNota.getText().trim().equals("")){
            ...
            if(tabMode.getRowCount()!=0){
                ...
                param.put("kontakrs",akses.getkontakrs());
                param.put("emailrs",akses.getemailrs());
                param.put("nota_jual",Sequel.cariIsi("select nota_jual from penjualan where nota_jual=?",NoNota.getText()));
                param.put("tgl_jual",Sequel.cariIsi("select DATE_FORMAT(tgl_jual, '%d-%m-%Y') from penjualan where nota_jual=?",NoNota.getText()));
                param.put("petugas",Sequel.cariIsi("select petugas.nama from penjualan inner join petugas on penjualan.nip=petugas.nip where nota_jual=?",NoNota.getText()));
                param.put("norm",Sequel.cariIsi("select no_rkm_medis from penjualan where nota_jual=?",NoNota.getText()));
                param.put("pasien",Sequel.cariIsi("select nm_pasien from penjualan where nota_jual=?",NoNota.getText()));
                param.put("alamat",Sequel.cariIsi("select pasien.alamat from penjualan inner join pasien on penjualan.no_rkm_medis=pasien.no_rkm_medis where nota_jual=?",NoNota.getText()));
                param.put("keterangan",Sequel.cariIsi("select keterangan from penjualan where nota_jual=?",NoNota.getText()));
                String hrg_ppn, hrg_ongkir, hrg_total;
                hrg_ppn = Sequel.cariIsi("select ppn from penjualan where nota_jual=?",NoNota.getText());
                hrg_ongkir = Sequel.cariIsi("select ongkir from penjualan where nota_jual=?",NoNota.getText());   
                hrg_total = Sequel.cariIsi("select SUM(total) from detailjual where nota_jual=?",NoNota.getText());                    
                double nilai = Double.valueOf(hrg_ppn) + Double.valueOf(hrg_ongkir) + Double.valueOf(hrg_total);
                param.put("ppn",Double.valueOf(hrg_ppn));
                param.put("ongkir",Double.valueOf(hrg_ongkir));                    
                param.put("ttl_tag",nilai);    
                param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
                Valid.MyReport("rptNotaApotek.jasper",param,"::[ Nota Apotek ]::");
            }
                ...
                try {
                    switch (tbDetailObatRacikan.getSelectedColumn()) {
                        case 7:
                            ...
                            tbDetailObatRacikan.setValueAt(0, tbDetailObatRacikan.getSelectedRow(),13);
                            tbDetailObatRacikan.setValueAt(0, tbDetailObatRacikan.getSelectedRow(),15);                             
                            break;
                        case 8:
                            tbDetailObatRacikan.setValueAt(0, tbDetailObatRacikan.getSelectedRow(),8);
                            break;
...
//                    harga[index]=Math.round(Double.parseDouble(tabMode.getValueAt(i,5).toString()));
                ...
                if(Jenisjual.getSelectedItem().equals("Karyawan")){
                    while(rs.next()){ 
                        tabModeDetailRacikan.addRow(new Object[]{
                            ...
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("karyawan"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Jual Bebas")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("jualbebas"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Beli Luar")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("beliluar"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Rawat Jalan")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("ralan"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Kelas 1")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("kelas1"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Kelas 2")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("kelas2"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Kelas 3")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("kelas3"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Utama/BPJS")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("utama"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("VIP")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("vip"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("VVIP")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("vvip"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),rs.getDouble("dasar"),"","",""
                        });
                    } 
                }
            } catch (Exception e) {
                ...
                if(Jenisjual.getSelectedItem().equals("Karyawan")){
                    while(rs.next()){ 
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("karyawan"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                    ...
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("jualbebas"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                            rs.getDouble("dasar"),rs.getString("no_batch"),rs.getString("no_faktur"),rs.getString("tgl_kadaluarsa")
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Beli Luar")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("beliluar"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                            rs.getDouble("dasar"),rs.getString("no_batch"),rs.getString("no_faktur"),rs.getString("tgl_kadaluarsa")
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Rawat Jalan")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("ralan"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                            rs.getDouble("dasar"),rs.getString("no_batch"),rs.getString("no_faktur"),rs.getString("tgl_kadaluarsa")
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Kelas 1")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("kelas1"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                            rs.getDouble("dasar"),rs.getString("no_batch"),rs.getString("no_faktur"),rs.getString("tgl_kadaluarsa")
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Kelas 2")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("kelas2"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                            rs.getDouble("dasar"),rs.getString("no_batch"),rs.getString("no_faktur"),rs.getString("tgl_kadaluarsa")
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Kelas 3")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("kelas3"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                            rs.getDouble("dasar"),rs.getString("no_batch"),rs.getString("no_faktur"),rs.getString("tgl_kadaluarsa")
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("Utama/BPJS")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("utama"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                            rs.getDouble("dasar"),rs.getString("no_batch"),rs.getString("no_faktur"),rs.getString("tgl_kadaluarsa")
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("VIP")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("vip"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                            rs.getDouble("dasar"),rs.getString("no_batch"),rs.getString("no_faktur"),rs.getString("tgl_kadaluarsa")
                        });
                    } 
                }else if(Jenisjual.getSelectedItem().equals("VVIP")){
                    while(rs.next()){                              
                        tabModeDetailRacikan.addRow(new Object[]{
                            tbObatRacikan.getValueAt(tbObatRacikan.getSelectedRow(),0).toString(),
                            rs.getString("kode_brng"),rs.getString("nama_brng"),rs.getString("nama"),rs.getString("kode_sat"),
                            Valid.roundUp(rs.getDouble("vvip"),100),rs.getDouble("kapasitas"),"",0,0,0,0,0,0,0,0,rs.getDouble("stok"),
                            rs.getDouble("dasar"),rs.getString("no_batch"),rs.getString("no_faktur"),rs.getString("tgl_kadaluarsa")
                        });
                    } 
                }
    ...
    public void setDokter(String nm_dokter,String nm_kamar){
        String gabung="";
        gabung = nm_dokter + " / " + nm_kamar;
        catatan.setText(gabung);
    }
