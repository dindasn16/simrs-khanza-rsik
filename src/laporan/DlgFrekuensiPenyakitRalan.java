    ...
    private void tampil2(){
            ...
            try{ 
                ps=koneksi.prepareStatement(
                    ...
                    "inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec "+
                    "inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel "+
                    "where reg_periksa.status_lanjut='Ralan' and diagnosa_pasien.status='Ralan' and reg_periksa.kd_poli<>'IGDK' and diagnosa_pasien.prioritas='1' and reg_periksa.tgl_registrasi between ? and ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and "+
                    "(penyakit.kd_penyakit like ? or penyakit.nm_penyakit like ?) group by penyakit.kd_penyakit order by penyakit.kd_penyakit desc");
                try {
                    ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                    ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
    //                ps.setString(3,"%"+nmpoli.getText().trim()+"%");
                    ps.setString(3,"%"+nmdokter.getText().trim()+"%");
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            ps2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
    //                        ps2.setString(3,"%"+nmpoli.getText().trim()+"%");
                            ps2.setString(3,"%"+nmdokter.getText().trim()+"%");
                            ...
                            ps2.setString(8,rs.getString("kd_penyakit"));
                            rs2=ps2.executeQuery();
                            Sequel.queryu("delete from temporary_surveilens_penyakit");
                            while(rs2.next()){
                                ps7=koneksi.prepareStatement("select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.prioritas<>'1' and diagnosa_pasien.status='Ralan' and diagnosa_pasien.no_rawat=?");    
                        ...
                        ps3=koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah from penyakit inner join diagnosa_pasien inner join reg_periksa inner join pasien_mati "+
                            ...
                            "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli and "+
                            "pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel and pasien_mati.no_rkm_medis=pasien.no_rkm_medis "+
                            "where reg_periksa.status_lanjut='Ralan' and diagnosa_pasien.status='Ralan' and reg_periksa.kd_poli<>'IGDK' and diagnosa_pasien.prioritas='1' and pasien.jk='L' and reg_periksa.tgl_registrasi between ? and ? "+
                            "and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? "+
                            "and diagnosa_pasien.kd_penyakit=? group by diagnosa_pasien.no_rawat");  
                        try{
                            ps3.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                            ps3.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
    //                        ps3.setString(3,"%"+nmpoli.getText().trim()+"%");
                            ps3.setString(3,"%"+nmdokter.getText().trim()+"%");
                            ...
                            ps3.setString(8,rs.getString("kd_penyakit"));
                            rs3=ps3.executeQuery();
                            rs3.last();
                            if(rs3.getRow()>0) a=rs3.getRow();
                        } catch (Exception e) {
                        ...
                        ps4=koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah from penyakit inner join diagnosa_pasien inner join reg_periksa inner join pasien_mati "+
                            ...
                            "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli and "+
                            "pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel and pasien_mati.no_rkm_medis=pasien.no_rkm_medis "+
                            "where reg_periksa.status_lanjut='Ralan' and diagnosa_pasien.status='Ralan' and reg_periksa.kd_poli<>'IGDK' and diagnosa_pasien.prioritas='1' and pasien.jk='P' and reg_periksa.tgl_registrasi between ? and ? "+
                            "and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? "+
                            "and diagnosa_pasien.kd_penyakit=? group by diagnosa_pasien.no_rawat"); 
                        try {
                            ps4.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                            ps4.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
    //                        ps4.setString(3,"%"+nmpoli.getText().trim()+"%");
                            ps4.setString(3,"%"+nmdokter.getText().trim()+"%");
                            ps4.setString(4,"%"+nmpenjab.getText().trim()+"%");
                            ps4.setString(5,"%"+nmkabupaten.getText().trim()+"%");
                            ps4.setString(6,"%"+nmkecamatan.getText().trim()+"%");
                            ps4.setString(7,"%"+nmkelurahan.getText().trim()+"%");
                            ps4.setString(8,rs.getString("kd_penyakit"));
                            rs4=ps4.executeQuery();
                            rs4.last();       
                            if(rs4.getRow()>0) b=rs4.getRow();
                        } catch (Exception e) {
                        ...
                        try{
                            ...
                            ps5.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
    //                        ps5.setString(3,"%"+nmpoli.getText().trim()+"%");
                            ps5.setString(3,"%"+nmdokter.getText().trim()+"%");
                            ps5.setString(4,"%"+nmpenjab.getText().trim()+"%");
                            ps5.setString(5,"%"+nmkabupaten.getText().trim()+"%");
                            ps5.setString(6,"%"+nmkecamatan.getText().trim()+"%");
                            ps5.setString(7,"%"+nmkelurahan.getText().trim()+"%");
                            ps5.setString(8,rs.getString("kd_penyakit"));
                            rs5=ps5.executeQuery();
                            rs5.last();
                            if(rs5.getRow()>0)  c=rs5.getRow()-a;
                        } catch (Exception e) {
                        ...
                        try{
                            ...
                            ps6.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
    //                        ps6.setString(3,"%"+nmpoli.getText().trim()+"%");
                            ps6.setString(3,"%"+nmdokter.getText().trim()+"%");
                            ps6.setString(4,"%"+nmpenjab.getText().trim()+"%");
                            ps6.setString(5,"%"+nmkabupaten.getText().trim()+"%");
                            ps6.setString(6,"%"+nmkecamatan.getText().trim()+"%");
                            ps6.setString(7,"%"+nmkelurahan.getText().trim()+"%");
                            ps6.setString(8,rs.getString("kd_penyakit"));
                            rs6=ps6.executeQuery();
                            rs6.last();
                            if(rs6.getRow()>0) d=rs6.getRow()-b;
                        } catch (Exception e) {
