...
public final class akses {
        ...
        try {        
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.hapus_data_lab=rs2.getBoolean("hapus_data_lab"); 
    ...
    public static boolean gethapus_data_lab(){return akses.hapus_data_lab;}
