...
public class DlgMutasiBarang extends javax.swing.JDialog {
    ...
    private double stok_asal,stok_tujuan,ttl1=0,ttl2=0,y1=0,y2=0;
    ...
    private void initComponents() {
        ...
        Hsementara.setName("Hsementara"); // NOI18N
        Hsementara.setPreferredSize(new java.awt.Dimension(80, 23));
        panelisi1.add(Hsementara);
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    private widget.Label Hsementara;
    ...
    private void getData() {
        if(tbDokter.getSelectedRow()>-1){  
            ...
            for(i=0;i<tbDokter.getRowCount();i++){ 
                y1=0;
                try {
                    y1=Double.parseDouble(tbDokter.getValueAt(i,2).toString());
                } catch (Exception e) {
                    y1=0;           
                }
                ttl1=ttl1+y1;
...
//                ttl2=ttl2+y2;
            ...
            Hsementara.setText(Valid.SetAngka(ttl1));
        }    
    }
